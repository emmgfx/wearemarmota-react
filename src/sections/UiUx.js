...
import imgLeftArrow from '../img/icons/ic_left-arrow.svg';
            ...
            <React.Fragment>
                ...
                <section id="features-more">
                    <div className="container">
                        ...
                        <h2 className="text-center">¿Quieres saber algo más sobre nuestro trabajo?</h2>
                        ...
                        <div className="text-center p-4">
                            <Link to="/" className="return-home"><img src={imgLeftArrow} alt="&larr;" /> Volver</Link>
                        </div>
                    </div>
                </section>
            </React.Fragment>
